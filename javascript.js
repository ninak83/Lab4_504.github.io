...
// notifies users that their location will be used if allowed

//switches map from light to dark theme depending on JS time of day script
...
function onLocationFound(e) { //this function does three things if the location is found: it defines a radius variable, adds a popup to the map, and adds a circle to the map.
  ...
  L.marker(e.latlng).addTo(map)
    .bindPopup("You are within " + radius + " meters of this location:" + "<br>" + e.latlng.lat + ", " + e.latlng.lng).openPopup();
